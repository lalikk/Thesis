...
public class AdvancedUserServiceImplTest extends AbstractTestNGSpringContextTests {
    ...
    private AdvancedUser userWithoutId;
    ...
    public void prepareTestUser() {
        ...
        userWithoutId = new AdvancedUser();
    ...
    public void testFindAll() {
        List<AdvancedUser> users = new ArrayList<>();
        users.add(user1);
        users.add(user2);

        when(userDao.findAll()).thenReturn(users);
        List<AdvancedUser> foundUsers = userService.findAll();
